...
<main class="relative flex h-screen flex-col overflow-hidden lg:flex-row">
    ...
    <div class="hidden lg:block md:w-[15vw]">
        <div
    ...
    <div class="flex min-h-0 flex-1 w-full items-center lg:w-[85vw]">
        <div
            class="h-full min-h-0 w-full overflow-y-auto [scrollbar-width:none] [&::-webkit-scrollbar]:hidden lg:h-[90%] lg:w-[90%]"
        >
